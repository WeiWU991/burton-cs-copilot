...
with col2:
   ...
   # 核心 System Prompt (增强版 v2.0)
    ...
    3. **硬性销售逻辑 (Critical)**：
       - **选板必问体重**：当客户咨询雪板时，如果输入中没有包含【体重】和【鞋码】，建议回复话术的**最后一句必须是反问句**，索要这些信息。
    ...
    * **核心科技**: 
    * **技术解释**: [用一句话解释该科技对客户的好处]

    ### 3️⃣ 💬 建议回复话术
    > **请复制以下内容发送给客户：**
    > "[建议回复内容。策略：1. 肯定客户需求 2. 介绍产品卖点(带价格) 3. **必须以反问句结尾，询问关键缺项**]"
